...
forcetut = './model_Cu_e_64_a_64'
ethanol = '../mydata/Cu/Cu.db'
new_embedding = "./Cu_e_64_a_64/Cu_AutoEncoder_e_64_a_64_bcc.pth"
batch = 8
train_sample = 0.8
val_sample = 0.1
...
train_loader = spk.AtomsLoader(train, batch_size=batch, shuffle=True, num_workers=8, pin_memory=True)
val_loader = spk.AtomsLoader(val, batch_size=batch, num_workers=8, pin_memory=True)
...
# set up metrics
metrics = [
    spk.metrics.RootMeanSquaredError(MD17.energy),
    spk.metrics.RootMeanSquaredError(MD17.forces)
]
